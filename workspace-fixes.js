...
function start(){installLayout();bind();startGeminiGate();const footer=qs('footer');if(footer&&!footer.querySelector('.support-email'))footer.insertAdjacentHTML('afterbegin',`<span class="support-email"><span>Support:</span> <a href="mailto:${EMAIL}">${EMAIL}</a></span>`);setTimeout(initEditions,0)}
